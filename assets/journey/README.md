...
- Paper grain, notched silhouette, perforation, airplane, landscape motifs, stars and stamps: vector components in `src/components/journey/LevelTicket.tsx`. No per-level bitmap cards.
